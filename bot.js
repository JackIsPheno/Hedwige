...
function createMagicalEmbed(serverInfo, host, port) {
...
if (serverInfo.online) {
    ...
    embed
        ...
        .setDescription(`${hogwartsEmojis.offline} **${randomMessage}**\n\n${hogwartsEmojis.potion} **Serveur:** \`${host}:${port}\``)
        .addFields(
            { 
                name: `${hogwartsEmojis.crystal} Statut`, 
                value: `**FERMÉ** 🌙`,
...
try {
    switch (interaction.commandName) {
        case 'poudlard':
            ...
            const embed = createMagicalEmbed(serverInfo, config.minecraftServer.host, config.minecraftServer.port, config.minecraftServer.displayName);
        ...
        case 'sortilege':
            const spells = [
                ...
                '✨ *Reparo!* - Les objets brisés se réparent'
            ];
